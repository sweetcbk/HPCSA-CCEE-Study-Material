...
#include<stdio.h>
#include<mpi.h>
#define NUM_ROWS_A 500 //rows of input [A]
#define NUM_COLUMNS_A 500 //columns of input [A]
#define NUM_ROWS_B 500 //rows of input [B]
#define NUM_COLUMNS_B 500 //columns of input [B]
